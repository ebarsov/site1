...
function specials() {
    ...
    switch($today) {
        case 'Sunday' :
            $content = 'Today\'s special takes us to the Alaskin Glaciers! Let\'s add some information about the wonderful Glaciers. To learn more about our Glacier Specials, click <a href="">here!</a>
        ';
        ...
        case 'Tuesday' :
             $content = 'Today\'s special takes us to Mt. Denali! Let\'s add some information about the wonderful scenery in Alaska. To learn more about our Mt. Denali, click <a href="">here!</a>
        ';

        case 'Wednesday' :
              $content = 'Today\'s special takes us to Lake Louise! Let\'s add some information about the wonderful lakes in Canada, including Lake Louise. To learn more about our Lake Louise and British Columbia, click <a href="">here!</a>
            ';

        case 'Thursday' :
            $content = 'Today\'s special takes us to the state of Wyoming and  Old Yellowstone. So much to see at Yellowstone, from Old Faithful, to Mamouth Falls, to the buffalo! Let\'s add some information about the wonderful wineries in California. To learn more about our California Specials, click <a href="">here!</a>
        ';
